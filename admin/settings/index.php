                ...
                <div class="settings_adm">
                    <div class="menu_settings_adm">
                        <div class="box_menu_settings_adm">
                            <div class="isi_menu_settings_adm" id="p_header_setting">Logo</div>
                            <div class="isi_menu_settings_adm" id="p_footer_setting">Social Media</div>
                            <div class="isi_menu_settings_adm" id="p_apikey_setting">API</div>
                            ...
                            <div class="isi_menu_settings_adm" id="p_email_smtp">SMTP</div>
                        </div>
                    </div>
