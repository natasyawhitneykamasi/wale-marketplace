...
<body>
    ...
    <div class="box_edit_time_fs" id="box_edit_time_fs">
        <div class="edit_time_fs">
            ...
            <p class="p_input" id="p_input_fs">Waktu Diskon</p>
            <input type="text" class="input" id="time_fs" value="<?php echo date("d M Y H:i:s", $wb_fs); ?>" placeholder="Waktu Diskon">
    ...
    <div class="back_popup_confirm" id="popup_hapus_produk">
        <div class="popup_confirm">
            ...
            <h5>Apakah anda yakin ingin manghapus produk ini dari diskon?</h5>
    ...
    <div class="admin">
        ...
        <div class="content_admin">
            <h1 class="title_content_admin">DISKON</h1>
